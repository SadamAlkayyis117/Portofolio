...
// CIRCULAR OPEN WORLD VERSION + LET'S CONNECT FINISH
// =====================================================
...
if (typeof THREE === "undefined") {
    ...
    if (!canvas) {
        ...
        const nightAmbient = new THREE.HemisphereLight(
            0x506080,
            0x10151f,
            0
        );
        ...
        function updateTimeModeUI() {
            ...
            timeModeUI.textContent = isNight
                ? "🌙 NIGHT"
                : "☀️ DAY";
        }
        ...
        function updateClouds(delta) {
            clouds.forEach((cloudData) => {
                cloudData.object.position.x +=
                    cloudData.speed * delta;
        ...
        const projects = {
            smartvoc: {
                ...
                about:
                    "An educational RPG that combines open-world exploration, missions, and vocabulary learning.",
                technologies:
                    "Godot Engine • GDScript • Blender • JSON",
                contribution:
                    "Game design, gameplay programming, UI implementation.",
                github:
            ...
            blockfight: {
                ...
                about:
                    "A gameplay-focused project developed to explore mechanics and real-time interaction.",
                technologies:
                    "Godot Engine • GDScript • Blender",
                contribution:
                    "Gameplay programming, mechanics implementation, level design.",
                github:
                    "https://github.com/SadamAlkayyis117",
                demo: "#"
            },
            ...
            uiux: {
                ...
                about:
                    "A collection of interface design and prototyping work focused on usability.",
                technologies:
                    "Figma • UI Design • UX Design • Prototyping",
                contribution:
                    "UI design, UX planning, wireframing, prototyping.",
                github: "#",
                demo: "#"
            },
            ...
            graphic: {
                ...
                about:
                    "A selection of graphic design work created across various projects.",
                technologies:
                    "CorelDRAW • Adobe Photoshop • Digital Illustration",
                contribution:
                    "Graphic design, illustration, composition, layout.",
                github: "#",
                demo: "#"
            }
        };
        ...
        function createIntroTexture() {
            ...
            ctx.fillText(
                "game development, UI/UX and creative digital projects.",
                512,
                345
            );
            ...
            ctx.fillText(
                "TEKAN E UNTUK MELIHAT ABOUT ME",
                512,
                445
            );
        ...
        function createFinishArea() {
            ...
            const finishBoard =
                new THREE.Mesh(
                    ...
                    new THREE.MeshStandardMaterial({
                        map: createFinishTexture()
                    })
                );

            finishBoard.position.set(
                0,
                3.4,
                0
            );
        ...
        function updateProjectDetection() {
            ...
            if (aboutBoard.group) {
                const dx =
                    player.position.x -
                    aboutBoard.group.position.x;

                const dz =
                    player.position.z -
                    aboutBoard.group.position.z;
        ...
        function openFinishScreen() {
            ...
            // Pastikan panel project dan about tertutup rapat
        ...
        document.addEventListener(
            ...
            (e) => {
                if (e.code === "Escape") {
                    if (finishOpen) {
                        restartPortfolio(); // Atau tutup finish screen
                    } else if (projectOpen) {
                        closeAllPanels();
                    }
                }
            ...
            npcs.forEach((npc) => {
                ...
                if (act === "WATER") {
                    ...
                    if (
                        ...
                        npc.userData.wateringCan.rotation.x =
                            -0.3 +
                            water * 0.3;
                    }
                }
        ...
        console.log(
            "=== CIRCULAR 3D WORLD + LET'S CONNECT RUNNING ==="
        );
    }
}
